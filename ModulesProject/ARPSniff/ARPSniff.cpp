...
class ARPSniff : public ModuleBase
{
public:
    ARPSniff()
    {
        RegisterOption("Filter", std::make_unique<OptString>(
            "", OptionRequired::Required,
            "The arp sniff filter"));
    }

    ModuleInfo Info() const override
    {
        ModuleInfo Info;
        Info.Name = "LocalNetwork/ARPSniff";
        Info.Description = "ARPSniff Tool";
    ...
    bool Run() override
    {
        ...
        std::cout << std::endl;
		ArpSniffA(&Dll, GetOption("Filter").c_str());    
        return true;
    }
};
