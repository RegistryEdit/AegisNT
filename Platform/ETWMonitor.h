...
enum class EventCategory : int {
    ...
    FileCreate, FileRead, FileWrite, FileDelete, FileRename, FileClose,
    FileFlush, FileQueryInfo, FileSetInfo,
    RegOpenKey, RegCreateKey, RegDeleteKey, RegDeleteValue,
    RegQueryValue, RegQueryKey, RegSetValue, RegCloseKey,
    RegEnumerateKey, RegEnumerateValueKey, RegFlush,
    TcpConnect, TcpAccept, TcpSend, TcpRecv, TcpDisconnect,
    UdpSend, UdpRecv,
    VirtualAlloc, VirtualFree, MemoryHardFault,
};
...
static const EtwProvider KProviders[] = {
    { L"Kernel-Process",  { 0x22fb2cd6,0x0e7b,0x422b,{0xa0,0xc7,0x2f,0xad,0x1f,0xd0,0xe7,0x16} }, 0, TRACE_LEVEL_VERBOSE },
    { L"Kernel-File",     { 0xedd08927,0x9cc4,0x4e65,{0xb9,0x70,0xc2,0x56,0x0f,0xb5,0xc2,0x61} }, 0, TRACE_LEVEL_VERBOSE },
    { L"Kernel-Registry", { 0x70eb4f03,0xc1de,0x4f73,{0xa0,0x51,0x33,0xd1,0x3d,0x54,0x13,0xbd} }, 0, TRACE_LEVEL_VERBOSE },
    { L"Kernel-Network",  { 0x7dd42a49,0x5329,0x4832,{0x8d,0xfd,0x43,0xd9,0x79,0x15,0x3a,0x88} }, 0, TRACE_LEVEL_VERBOSE },
    { L"Kernel-Memory",   { 0xd1d93ef7,0xe1f2,0x4f45,{0x99,0x43,0x03,0xd2,0x45,0xfe,0x6c,0x00} }, 0, TRACE_LEVEL_VERBOSE },
};
static constexpr int KProviderCount = sizeof(KProviders) / sizeof(KProviders[0]);

static const GUID GuidKernelProcess = { 0x22fb2cd6,0x0e7b,0x422b,{0xa0,0xc7,0x2f,0xad,0x1f,0xd0,0xe7,0x16} };
static const GUID GuidKernelFile = { 0xedd08927,0x9cc4,0x4e65,{0xb9,0x70,0xc2,0x56,0x0f,0xb5,0xc2,0x61} };
static const GUID GuidKernelRegistry = { 0x70eb4f03,0xc1de,0x4f73,{0xa0,0x51,0x33,0xd1,0x3d,0x54,0x13,0xbd} };
static const GUID GuidKernelNetwork = { 0x7dd42a49,0x5329,0x4832,{0x8d,0xfd,0x43,0xd9,0x79,0x15,0x3a,0x88} };
static const GUID GuidKernelMemory = { 0xd1d93ef7,0xe1f2,0x4f45,{0x99,0x43,0x03,0xd2,0x45,0xfe,0x6c,0x00} };
static const GUID GuidSystemTraceControl = { 0x9e814aad,0x3204,0x11d2,{0x9a,0x82,0x00,0x60,0x08,0xa8,0x69,0x39} };
static const GUID GuidWindowsToolEtw = { 0x7d5b8a1c,0x1f54,0x4f25,{0x9d,0x3c,0x71,0x9d,0x3e,0x4b,0x2a,0x10} };
...
static EventCategory ClassifyEvent(const GUID& ProviderGuid, USHORT EventId) {
    if (ProviderGuid == GuidKernelProcess) {
        switch (EventId) {
        case 1: return EventCategory::ProcessCreate;
        case 2: return EventCategory::ProcessExit;
        case 3: return EventCategory::ThreadCreate;
        case 4: return EventCategory::ThreadExit;
        case 5: return EventCategory::ImageLoad;
        case 6: return EventCategory::ImageUnload;
        }
    }
    else if (ProviderGuid == GuidKernelFile) {
        switch (EventId) {
        case 30: return EventCategory::FileCreate;
        case 32: return EventCategory::FileCreate;
        case 35: return EventCategory::FileDelete;
        case 36: return EventCategory::FileRename;
        case 40: return EventCategory::FileWrite;
        case 41: return EventCategory::FileWrite;
        case 42: return EventCategory::FileRead;
        case 43: return EventCategory::FileRead;
        case 44: return EventCategory::FileClose;
        }
    }
    else if (ProviderGuid == GuidKernelRegistry) {
        switch (EventId) {
        case 1:  return EventCategory::RegCreateKey;
        case 2:  return EventCategory::RegOpenKey;
        case 3:  return EventCategory::RegDeleteKey;
        case 4:  return EventCategory::RegQueryKey;
        case 6:  return EventCategory::RegSetValue;
        case 7:  return EventCategory::RegDeleteValue;
        case 8:  return EventCategory::RegQueryValue;
        case 9:  return EventCategory::RegEnumerateKey;
        case 10: return EventCategory::RegEnumerateValueKey;
        case 13: return EventCategory::RegCloseKey;
        }
    }
    else if (ProviderGuid == GuidKernelNetwork) {
        switch (EventId) {
        case 10: return EventCategory::TcpSend;
        case 11: return EventCategory::TcpRecv;
        case 12: return EventCategory::TcpConnect;
        case 13: return EventCategory::TcpAccept;
        case 15: return EventCategory::TcpDisconnect;
        case 26: return EventCategory::UdpSend;
        case 27: return EventCategory::UdpRecv;
        }
    }
    else if (ProviderGuid == GuidKernelMemory) {
        switch (EventId) {
        case 1: return EventCategory::VirtualAlloc;
        case 2: return EventCategory::VirtualFree;
        case 5: return EventCategory::MemoryHardFault;
        }
    }
...
static ParsedEvent ParseEvent(PEVENT_RECORD Rec) {
    ...
    Evt.Category = ClassifyEvent(Rec->EventHeader.ProviderId, Rec->EventHeader.EventDescriptor.Id);
    switch (Evt.Category) {
...
static const WCHAR* CategoryToString(EventCategory Cat) {
    switch (Cat) {
    case EventCategory::ProcessCreate:        return L"Process Create";
    case EventCategory::ProcessExit:          return L"Process Exit";
    case EventCategory::ThreadCreate:         return L"Thread Create";
    case EventCategory::ThreadExit:           return L"Thread Exit";
    case EventCategory::ImageLoad:            return L"DLL Load";
    case EventCategory::ImageUnload:          return L"DLL Unload";
    case EventCategory::FileCreate:           return L"File Create";
    case EventCategory::FileRead:             return L"File Read";
    case EventCategory::FileWrite:            return L"File Write";
    case EventCategory::FileDelete:           return L"File Delete";
    case EventCategory::FileRename:           return L"File Rename";
    case EventCategory::FileClose:            return L"File Close";
    case EventCategory::RegOpenKey:           return L"Reg OpenKey";
    case EventCategory::RegCreateKey:         return L"Reg CreateKey";
    case EventCategory::RegDeleteKey:         return L"Reg DeleteKey";
    case EventCategory::RegDeleteValue:       return L"Reg DeleteValue";
    case EventCategory::RegQueryValue:        return L"Reg QueryValue";
    case EventCategory::RegQueryKey:          return L"Reg QueryKey";
    case EventCategory::RegSetValue:          return L"Reg SetValue";
    case EventCategory::RegCloseKey:          return L"Reg CloseKey";
    case EventCategory::RegEnumerateKey:      return L"Reg EnumKey";
    case EventCategory::RegEnumerateValueKey: return L"Reg EnumValue";
    case EventCategory::TcpConnect:           return L"TCP Connect";
    case EventCategory::TcpAccept:            return L"TCP Accept";
    case EventCategory::TcpSend:              return L"TCP Send";
    case EventCategory::TcpRecv:              return L"TCP Recv";
    case EventCategory::TcpDisconnect:        return L"TCP Disconnect";
    case EventCategory::UdpSend:              return L"UDP Send";
    case EventCategory::UdpRecv:              return L"UDP Recv";
    case EventCategory::VirtualAlloc:         return L"VirtualAlloc";
    case EventCategory::VirtualFree:          return L"VirtualFree";
    case EventCategory::MemoryHardFault:      return L"Memory Fault";
...
static WORD CategoryToColor(EventCategory Cat) {
    ...
    case EventCategory::ThreadCreate:
    case EventCategory::ThreadExit:         return 10;
    case EventCategory::FileCreate:
    case EventCategory::FileWrite:
    case EventCategory::FileRead:
    case EventCategory::FileDelete:
    case EventCategory::FileRename:
    case EventCategory::FileClose:          return 11;
    case EventCategory::RegOpenKey:
    case EventCategory::RegCreateKey:
    case EventCategory::RegDeleteKey:
    case EventCategory::RegDeleteValue:
    ...
    case EventCategory::RegEnumerateValueKey: return 13;
    ...
    case EventCategory::UdpRecv:            return 9;
    case EventCategory::VirtualAlloc:
    case EventCategory::VirtualFree:
    case EventCategory::MemoryHardFault:    return 14;
    default: return 7;
    }
}
...
static void PrintParsedEvent(const ParsedEvent& Evt) {
    ...
    case EventCategory::RegQueryValue:
    case EventCategory::RegDeleteValue:
        wprintf(L" Key:%s Value:%s", Evt.RegistryPath.c_str(), Evt.ValueName.c_str());
        break;
    case EventCategory::RegOpenKey:
    case EventCategory::RegCreateKey:
    case EventCategory::RegDeleteKey:
...
static void SetEtwEventCallback(std::function<void(const ParsedEvent&)> Callback) {
    G_EtwEventCallback = std::move(Callback);
}

static ULONG GetLastStartTraceStatus() {
    return G_LastStartTraceStatus;
}
...
static void WINAPI EventRecordCallback(PEVENT_RECORD Rec) {
    EventCategory Cat = ClassifyEvent(Rec->EventHeader.ProviderId, Rec->EventHeader.EventDescriptor.Id);
...
static BOOL StartKernelTrace() {
    ...
    for (int I = 0; I < KProviderCount; I++) {
        Status = EnableTraceEx2(G_SessionHandle, &KProviders[I].Guid,
            EVENT_CONTROL_CODE_ENABLE_PROVIDER,
            KProviders[I].Level,
            KProviders[I].MatchAnyKeyword,
            0, 0, NULL);
        if (Status == ERROR_SUCCESS) {
            ++EnabledProviders;
