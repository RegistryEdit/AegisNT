...
{
public:
    Option(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
...
{
public:
    OptString(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
...
{
public:
    OptBool(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
        : Option(DefaultValue, Required, Description) {}

    bool Validate(const std::string& Value) const override
    {
        std::string Lower;
        for (char C : Value) Lower += static_cast<char>(std::tolower(C));
...
{
public:
    OptInt(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
        : Option(DefaultValue, Required, Description) {}
...
{
public:
    OptPort(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
        : Option(DefaultValue, Required, Description) {}
...
{
public:
    OptAddress(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
        : Option(DefaultValue, Required, Description) {}
...
{
public:
    OptAddressRange(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
        : Option(DefaultValue, Required, Description) {}
    ...
    bool Validate(const std::string& Value) const override
    {
        ...
        if (!Addr.Validate(Value.substr(0, SlashPos))) return false;
...
{
public:
    OptPath(const std::string& DefaultValue, OptionRequired Required, const std::string& Description)
        : Option(DefaultValue, Required, Description) {}
...
{
public:
    OptEnum(const std::vector<std::string>& Choices, const std::string& DefaultValue,
            OptionRequired Required, const std::string& Description)
